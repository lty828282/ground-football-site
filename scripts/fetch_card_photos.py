...
CARD_QUERIES = {
    ...
    "recovery-stretch": {
        ...
        4: ["youth soccer player stretching field", "kids soccer team stretching",
            "young football player stretching ground", "teenager soccer stretching",
            "child athlete stretching legs field", "boy soccer sitting stretch"],
