...
QUERIES = {
    ...
    "rice":  ["steamed white rice bowl top view", "white rice bowl closeup", "bowl of cooked white rice"],
    "fish":  ["grilled salmon fillet plate", "grilled fish dish", "cooked fish fillet"],
    "veg":   ["steamed broccoli carrots plate", "green vegetables plate", "fresh salad vegetables bowl"],
